...
namespace Ravlyk.SAE.Drawing.Grid
{
	public class PatternGridPainter
	{
        ...
        #region LegendPaintMode

        /// <summary>
        /// Pattern grid stitches paint mode.
        /// </summary>
        public enum LegendPaintMode
        {
            /// <summary>
            /// Draw only black symbols.
            /// </summary>
		...
		public LegendPaintMode LegendPaint { get; set; }
		...
		public double LineWidthD { get; set; }
		...
		public void PaintHRuler(IPainter painter, Rectangle canvasClipRect, int startIndex, int endIndexExclusive)
		{
		...
		public void PaintVRuler(IPainter painter, Rectangle canvasClipRect, int startIndex, int endIndexExclusive)
		{
			var left = canvasClipRect.Left;
        ...
        internal int GetBackLegend(Color pixelColor)
        {
            switch (LegendPaint)
            {
                case LegendPaintMode.Symbols:
                case LegendPaintMode.ColoredSymbols:
                case LegendPaintMode.Cross:
                    return WhiteColorArgb;
                case LegendPaintMode.WhiteSymbols:
                    return BlackColorArgb;
                case LegendPaintMode.HalfTones:
                    return pixelColor.HalfToneHighColor.Argb;
                case LegendPaintMode.Full:
                case LegendPaintMode.Colors:
                    return pixelColor.Argb;
                default:
                    return WhiteColorArgb;
            }
        }
        internal int GetSymbolLegend(Color pixelColor)
        {
            switch (LegendPaint)
            {
                case LegendPaintMode.Symbols:
