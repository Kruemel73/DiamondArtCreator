...
namespace Ravlyk.SAE.Drawing.Processor
{
	public class PaletteController
	{
			...
			if (mode == OrderMode)
			{
				switch (orderMode)
				{
					...
					case ColorsOrderMode.Count:
						...
						break;
					case ColorsOrderMode.Bags:
						mode = ColorsOrderMode.BagsDesc;
						break;
					...
					case ColorsOrderMode.CountDesc:
						...
						break;
					case ColorsOrderMode.BagsDesc:
						mode = ColorsOrderMode.Bags;
						break;
		...
		public class ColorInfo
		{
			...
			public int Bags => (Color.UsageOccurrences.Count + ((Color.UsageOccurrences.Count / 100) * SAEWizardSettings.Default.Reserve)) / SAEWizardSettings.Default.Bagsize + 1;
            //public int Bags => Color.UsageOccurrences.Count / SAEWizardSettings.Default.Bagsize + 1;
