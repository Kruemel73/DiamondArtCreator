			...
			if (controller != null)
			{
				...
				try
				{
					...
					if (panelV.Visible)
					{
						...
						if (controller.VPosition >= vScrollBar.Maximum) { controller.VPosition = vScrollBar.Maximum; }
					...
					if (panelH.Visible)
					{
						...
						if (controller.HPosition >= hScrollBar.Maximum) { controller.HPosition = hScrollBar.Maximum; }
